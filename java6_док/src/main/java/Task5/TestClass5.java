...
/**
 * Класс TestClass5.
 * <p>Содержит метод для обработки аннотации @Two через Reflection API.</p>
 */
public class TestClass5 {

    /**
     * Проверяет наличие аннотации @Two у класса.
     * <p>Если аннотация есть — выводит значения свойств first и second.</p>
     *
     * @param class1 класс, который проверяется
     */
